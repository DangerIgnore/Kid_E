...
public class HighlightableObject : MonoBehaviour
{
    ...
    public bool IsConstantly => constantly;
    ...
    private class HighlightingRendererCache
    {
        ...
        {
            rendererCached.materials = state ? replacementMaterials : sourceMaterials;
            //rendererCached.materials = state ? sourceMaterials.Union(replacementMaterials).ToArray() : sourceMaterials;
        }
